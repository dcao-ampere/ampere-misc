...
int main(void)
{
    ...
    sdbusplus::server::manager::manager objManager(bus, PERIPHERAL_OBJ_PATH_ROOT);
    phosphor::nic::PeripheralManager objMgr(bus);
    bus.request_name(PERIPHERAL_REQUEST_NAME);
